...
const Activities = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 place-items-center sm:mx-[100px] my-8'>
        ...
        <ActivityCard className='col-span-2' name='Arcade' description='This is a Arcade' image='/arcade.jpg' />
